...
function createFiles(host, options) {
    ...
    const filesDirName = options.preset === presets_1.Preset.NPM || options.preset === presets_1.Preset.Core
        ? './files-npm'
        : './files';
    (0, devkit_1.generateFiles)(host, (0, path_1.join)(__dirname, filesDirName), options.directory, Object.assign(Object.assign({ formattedNames, dot: '.', tmpl: '', workspaceFile: options.cli === 'angular' ? 'angular' : 'workspace', cliCommand: options.cli === 'angular' ? 'ng' : 'nx', nxCli: false, typescriptVersion: versions_1.typescriptVersion,
